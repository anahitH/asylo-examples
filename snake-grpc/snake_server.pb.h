...
#ifndef PROTOBUF_INCLUDED_snake_5fserver_2eproto
#define PROTOBUF_INCLUDED_snake_5fserver_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_snake_5fserver_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_snake_5fserver_2eproto {
...
class ReturnValue : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:examples.grpc_server.ReturnValue) */ {
 ...
 private:
  ...
  friend struct ::TableStruct_snake_5fserver_2eproto;
};
// -------------------------------------------------------------------
...
// optional int32 eat_gold = 1;
inline bool ReturnValue::has_eat_gold() const {
...
// optional int32 row = 1;
inline bool SnakeSegment::has_row() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
...
// optional int32 col = 2;
inline bool SnakeSegment::has_col() const {
...
// optional uint32 speed = 1;
inline bool Snake::has_speed() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
...
inline void Snake::set_direction(::examples::grpc_server::Snake_direction_t value) {
  assert(::examples::grpc_server::Snake_direction_t_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  direction_ = value;
...
// optional int32 len = 3;
inline bool Snake::has_len() const {
...
// optional int32 level = 1;
inline bool Screen::has_level() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
...
// optional int32 score = 2;
inline bool Screen::has_score() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
...
// optional int32 highScore = 3;
inline bool Screen::has_highscore() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
...
// optional int32 gold = 4;
inline bool Screen::has_gold() const {
...
// optional int32 obstacles = 5;
inline bool Screen::has_obstacles() const {
...
inline void EnclaveInput::clear_snake_in() {
  if (snake_in_ != nullptr) snake_in_->Clear();
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void EnclaveInput::clear_screen_in() {
  if (screen_in_ != nullptr) screen_in_->Clear();
  _has_bits_[0] &= ~0x00000002u;
}
...
inline void EnclaveOutput::clear_snake_out() {
  if (snake_out_ != nullptr) snake_out_->Clear();
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void EnclaveOutput::clear_screen_out() {
  if (screen_out_ != nullptr) screen_out_->Clear();
  _has_bits_[0] &= ~0x00000002u;
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_snake_5fserver_2eproto
